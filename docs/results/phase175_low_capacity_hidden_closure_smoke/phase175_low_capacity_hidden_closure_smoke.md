...
- Selected variant: `phase173_tiny_explicit_latent_hidden_closure_smoke`
- Candidate variant: `low_capacity_explicit_latent_hidden_closure_head`
- Best control variant: `phase173_tiny_explicit_latent_hidden_closure_smoke`
- Validation score gain vs best control: `-0.0004223396`
- Phase 173 validation score gain: `-0.0004223396`
- Phase 176 focused review allowed: `false`
- Phase 175 model training allowed: `false`
- A100 training allowed now: `false`
- A100-SXM4-80GB request now: `false`

## Interpretation
This is a tiny synthetic low-capacity smoke. A closed gate means the extra low-capacity head did not beat the simpler Phase 173 explicit latent control under validation-only selection. It is not AM-Bench evidence, not Bayesian PINN training, not a GCN/CNN/operator route, and not an A100-80GB justification.

## Variants
| variant_id | family | source_estimator | closure_estimator | executed | is_control | trainable | description |
| --- | --- | --- | --- | --- | --- | --- | --- |
| low_capacity_explicit_latent_hidden_closure_head | mechanism_candidate | ridge_head_over_phase173_latent_posterior_grid_features | ridge_head_alpha_1e-6 | true | false | true | low-capacity head predicting source center, width, and closure |
| phase173_tiny_explicit_latent_hidden_closure_smoke | control | phase173_continuous_center_width_coordinate_search | phase173_calibrated_optimized_closure_head | true | true | true | required Phase 173 trainable-latent control |
...
| low_capacity_explicit_latent_hidden_closure_head | mechanism_candidate | val | 3 | 48 | 0.0065747861 | 0.0093167773 | 0.0096634987 | 0.0158633048 | 0.8819444444 | 0.0242464145 | 0.0114151779 |
| low_capacity_explicit_latent_hidden_closure_head | mechanism_candidate | test | 3 | 48 | 0.0062865865 | 0.0081336256 | 0.0096557673 | 0.0141827286 | 0.9375 | 0.0220159348 | 0.0100782715 |
...
| phase173_tiny_explicit_latent_hidden_closure_smoke | control | val | 3 | 48 | 0.006271794 | 0.0085512203 | 0.0089651896 | 0.0160014312 | 0.8819444444 | 0.0238240749 | 0.0111767491 |
| phase173_tiny_explicit_latent_hidden_closure_smoke | control | test | 3 | 48 | 0.0059616267 | 0.0074503416 | 0.0087659511 | 0.0140415939 | 0.9375 | 0.0213594856 | 0.0091051469 |
...
| 171 | low_capacity_explicit_latent_hidden_closure_head | val | 16 | 0.0066192266 | 0.0185738638 | 0.0265341922 |
| 171 | low_capacity_explicit_latent_hidden_closure_head | test | 16 | 0.006200351 | 0.0153261846 | 0.022859243 |
...
| 171 | phase173_tiny_explicit_latent_hidden_closure_smoke | val | 16 | 0.006663995 | 0.0183809643 | 0.026613519 |
| 171 | phase173_tiny_explicit_latent_hidden_closure_smoke | test | 16 | 0.0058561301 | 0.0151544788 | 0.0221824065 |
...
| 172 | low_capacity_explicit_latent_hidden_closure_head | val | 16 | 0.0061040196 | 0.0127979565 | 0.020873016 |
| 172 | low_capacity_explicit_latent_hidden_closure_head | test | 16 | 0.006139333 | 0.016966449 | 0.0238347259 |
...
| 172 | phase173_tiny_explicit_latent_hidden_closure_smoke | val | 16 | 0.0055883085 | 0.0126834291 | 0.0199192285 |
| 172 | phase173_tiny_explicit_latent_hidden_closure_smoke | test | 16 | 0.0059120355 | 0.0168341667 | 0.0233378705 |
...
| 173 | low_capacity_explicit_latent_hidden_closure_head | val | 16 | 0.0070011122 | 0.016218094 | 0.0253320352 |
| 173 | low_capacity_explicit_latent_hidden_closure_head | test | 16 | 0.0065200754 | 0.0102555522 | 0.0193538355 |
...
| 173 | phase173_tiny_explicit_latent_hidden_closure_smoke | val | 16 | 0.0065630785 | 0.0169399003 | 0.0249394772 |
| 173 | phase173_tiny_explicit_latent_hidden_closure_smoke | test | 16 | 0.0061167146 | 0.0101361362 | 0.0185581798 |
