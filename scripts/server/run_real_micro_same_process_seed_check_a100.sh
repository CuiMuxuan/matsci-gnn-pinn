...
do
  ...
  MICRO_SAMPLE_ID="AMB2022-718-SH1-BP1-P3-L0-2_m" \
  RUN_TAG_SUFFIX="sameproc_AMB2022_718_SH1_BP1_P3_L0_2_m_seedcheck" \
  RUN_G4=1 \
  RUN_G8=0 \
  SEED="$seed" \
  ACTIVE_ID="$ACTIVE_ID" \
  ...
  MICRO_AGGREGATE=0 \
  MICRO_FEATURES="$MICRO_FEATURES" \
  MICRO_SAMPLE_ID="AMB2022-718-SH1-BP1-P4-L0-2" \
  RUN_TAG_SUFFIX="sameproc_AMB2022_718_SH1_BP1_P4_L0_2_seedcheck" \
  RUN_G4=0 \
  RUN_G8=1 \
  SEED="$seed" \
  ACTIVE_ID="$ACTIVE_ID" \
