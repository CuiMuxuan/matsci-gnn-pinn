...
for split_strategy in $PROFILE_SPLITS; do
  case "$split_strategy" in
    line)
      run_broad_selector_holdout line 0.6 0.2 0.2
      ;;
    laser_power)
      run_broad_selector_holdout laser_power 0.34 0.33 0.33
      ;;
    scan_speed)
      run_broad_selector_holdout scan_speed 0.34 0.33 0.33
      ;;
    spot_size)
      run_broad_selector_holdout spot_size 0.34 0.33 0.33
      ;;
    process)
      run_broad_selector_holdout process 0.6 0.2 0.2
      ;;
    *)
